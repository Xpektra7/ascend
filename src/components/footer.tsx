...
export default function Footer() {
  return (
    <section className="wrapper">
      <div className="container py-24 px-4 md:px-16">
      ...
      <div className="container border-t border-border">
        <div className="py-8 flex items-center justify-center gap-3 text-sm px-4 md:px-16">
          <a
          ...
          <span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-foreground text-purple-500! transition-colors"
            >
              Xpektra
            </a>{" "}
            — Ascend 2026
