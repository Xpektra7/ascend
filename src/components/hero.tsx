...
export default function Hero() {
  return (
    <section className="wrapper">
      <div className="container h-[calc(100vh-6rem)] flex flex-col items-center justify-center gap-8 px-8 md:px-16">
        <p className="text-base md:text-xl">3-day AI & design conference</p>
